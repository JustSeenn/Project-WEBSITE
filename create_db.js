...
var load = function() {
    ...
    db.prepare('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT, username TEXT, firstname TEXT, lastname TEXT,email TEXT, adress TEXT, password TEXT, avatar BLOB, description TEXT, date DATE)').run();
    ...
    db.prepare('CREATE TABLE user_actions (id_u INTEGER, id_a INTEGER,PRIMARY KEY(id_u,id_a))').run();
